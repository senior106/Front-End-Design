    ...
    <div class="h-screen bg-bgColor font-prototype">
      <header class="text-gray-600 body-font pt-2">
        <div class="container mx-auto flex flex-wrap px-5 py-4 flex-col md:flex-row items-center">
          <a
            href="#"
            class="flex title-font font-medium items-center text-gray-900 mb- "
          >
            <span class="ml-3 text-3xl font-bold text-textBlack">LOGO</span>
          </a>
          <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
            <a href="#" class=" text-green-500 font-normal">
              BN
            </a>
            <span class="mx-2">/</span>
            <a href="#" class=" text-textBlack font-normal">
              EN
            </a>
          </nav>
        </div>
      ...
      <div class="">
        <div class="container mx-auto flex flex-wrap  flex-row items-start">
          <nav class="flex w-4/5 uppercase flex-wrap items-start text-base pl-14">
            <a href="#" class="mr-6 text-lg text-buttonColor">
              home
            </a>
            <a href="#" class="mr-6 text-lg text-textBlue ">
              advertisers
            </a>
            <a href="#" class="mr-6 text-lg text-textBlue ">
              publishers
      ...
      <section class="">
        <div class="container mx-auto flex px-5 py-12 md:flex-row flex-col items-center">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col  mb-16 md:mb-0 items-center text-center">
            <h1 class="title-font sm:text-4xl text-2xl mb-4 font-normal text-textBlue">
              Best News Porvide Site
            </h1>
            <p class="mb-8 leading-relaxed text-textBlack text-lg">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Veniam
              quasi non repellat ab ut doloremque, adipisci ipsum, commodi quos
              quisquam consequatur sapiente sit culpa vel aliquam architecto.
              Repellendus, quo rerum?
            </p>
          </div>
